...
class DeleteUserScores extends Operation {
  constructor({ PersonKeypointRepository, ScoreRepository }) {
    super();
...
DeleteUserScores.setEvents(['SUCCESS', 'ERROR', 'VALIDATION_ERROR', 'NOT_FOUND']);

module.exports = DeleteUserScores;
